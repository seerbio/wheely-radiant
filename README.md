**wheely-pythia**: Reader for Pythia results, compatible with [`wheely-mammoth`](https://github.com/seerbio/wheely-mammoth)
...
```shell
pip install git+ssh://git@github.com/seerbio/wheely-pythia
```
